...
<?php } ?>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-2 table table-bordered table-striped	 display table-responsive" style=" display: table;;overflow-x: auto;width: 100%">
									<thead>
										<tr>
											<th>#</th>
											<th> Name</th>
