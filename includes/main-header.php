...
<div class="logo">
	<a href="index.php">
   <img src="sit.jpeg" width="50" height="50" style="border-radius: 50%;margin-left:-15px"> 
		<h3 style="color: black;margin-top: -35px;margin-left: 45px;"> SIT STORE PORTAL</h3>
...
<br><br><br>
				...
				<div class="col-xs-12 col-sm-12 col-md-5 animate-dropdown top-cart-row" style="margin-left: 600px;margin-top: -50px">
